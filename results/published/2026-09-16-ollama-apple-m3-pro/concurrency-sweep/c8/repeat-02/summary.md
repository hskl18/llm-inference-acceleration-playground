...
- Prompt count: `32`
- Workload fingerprint: `c348c5bf165e43bd`
- Shared prefix tokens estimate: `4`
- Shared prefix fingerprint: `925521b5267b8614`
...
| Failed requests | 0 |
| Timeout count | 0 |
| Latency p50 | 9511.605 ms |
| Latency p95 | 10133.620 ms |
| Latency p99 | 10188.465 ms |
| TTFT p50 | 8788.840 ms |
| TTFT p95 | 9485.921 ms |
| TTFT p99 | 9531.133 ms |
| TPOT p50 | 11.422 ms |
| TPOT p95 | 14.224 ms |
| TPOT p99 | 15.208 ms |
| Inter-token latency samples | 2016 |
| Inter-token latency p50 | 11.076 ms |
| Inter-token latency p95 | 16.252 ms |
| Inter-token latency p99 | 22.999 ms |
| Queue delay p50 | 0.001 ms |
| Queue delay p95 | 0.007 ms |
| Queue delay p99 | 0.011 ms |
| End-to-end latency p50 | 9511.614 ms |
| End-to-end latency p95 | 10133.622 ms |
| End-to-end latency p99 | 10188.468 ms |
| Output tokens/sec | 53.502 |
| Requests/sec | 0.836 |
...
- Good requests/sec: `0.026`
- Good output tokens/sec: `1.672`
